...
import cn.rongcloud.aochuang.db.DBManager;
import cn.rongcloud.aochuang.db.Friend;
import cn.rongcloud.aochuang.db.GroupMember;
import cn.rongcloud.aochuang.db.Groups;
import cn.rongcloud.aochuang.db.GroupsDao;
import cn.rongcloud.aochuang.model.SealSearchConversationResult;
...
import cn.rongcloud.aochuang.server.utils.OperationRong;
import cn.rongcloud.aochuang.server.utils.RongGenerate;
import cn.rongcloud.aochuang.server.utils.json.JsonMananger;
import cn.rongcloud.aochuang.server.utils.photo.PhotoUtils;
import cn.rongcloud.aochuang.server.widget.BottomMenuDialog;
import cn.rongcloud.aochuang.server.widget.DialogWithYesOrNoUtils;
import cn.rongcloud.aochuang.server.widget.LoadDialog;
import cn.rongcloud.aochuang.server.widget.SelectableRoundedImageView;
import cn.rongcloud.aochuang.ui.widget.DemoGridView;
import cn.rongcloud.aochuang.ui.widget.switchbutton.SwitchButton;
...
public class GroupDetailActivity extends BaseActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private LinearLayout mIsmanager;
    ...
    private void initGroupData() {
        ...
        if (!isCreated) {
            ...
            mIsmanager.setVisibility(View.GONE);
        } else {
            mGroupAnnouncementDividerLinearLayout.setVisibility(View.VISIBLE);
    ...
    private void initViews() {
        ...
        mIsmanager = (LinearLayout) findViewById(R.id.ismanager);
